...
protected:
	...
	afx_msg short DeleteAll();
	afx_msg short DeleteCriterion(short index);
	afx_msg short GetMinMaxBest(short index, double FAR* min_value, double FAR* max_value, double FAR* best_value);
	afx_msg short SetHWND(long hwnd);
	afx_msg short SetCriterionName(short index, LPCTSTR Name);
	afx_msg long GetCriterionIndex(LPCTSTR Name);
	//}}AFX_DISPATCH
